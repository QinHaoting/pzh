...
public class UserController {
    ...
    public R updateUser(@RequestBody User user) {
        LambdaQueryWrapper<User> userLambdaQueryWrapper = new LambdaQueryWrapper<>();
        userLambdaQueryWrapper.eq(true, User::getId, user.getId());
        User userTemp = userServiceImpl.getById(userLambdaQueryWrapper);
        user.setPassword(userTemp.getPassword()); // 用户信息界面不允许修改密码
